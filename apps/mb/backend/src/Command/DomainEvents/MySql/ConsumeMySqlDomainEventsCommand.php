...
namespace MyBonsaiApi\Apps\Mb\Backend\Command\DomainEvents\MySql;
...
use MyBonsaiApi\Shared\Infrastructure\Bus\Event\MySql\MySqlDoctrineDomainEventsConsumer;
...
{
    protected static $defaultName = 'mybonsaiapi:domain-events:mysql:consume';
    private $consumer;
