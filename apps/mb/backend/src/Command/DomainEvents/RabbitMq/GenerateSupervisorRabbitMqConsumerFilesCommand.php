...
namespace MyBonsaiApi\Apps\Mb\Backend\Command\DomainEvents\RabbitMq;

use MyBonsaiApi\Shared\Domain\Bus\Event\DomainEventSubscriber;
use MyBonsaiApi\Shared\Infrastructure\Bus\Event\DomainEventSubscriberLocator;
use MyBonsaiApi\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqQueueNameFormatter;
...
{
    protected static $defaultName = 'mybonsaiapi:domain-events:rabbitmq:generate-supervisor-files';
    ...
    {
        return <<<EOF
[program:mybonsaiapi_{queue_name}]
command      = {path}/apps/mb/backend/bin/console mybonsaiapi:domain-events:rabbitmq:consume --env=prod {queue_name} {events_to_process}
