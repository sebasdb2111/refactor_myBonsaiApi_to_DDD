...
use MyBonsaiApi\Shared\Infrastructure\Bus\Event\RabbitMq\RabbitMqDomainEventsConsumer;
use MyBonsaiApi\Shared\Infrastructure\Doctrine\DatabaseConnections;
...
{
    protected static $defaultName = 'mybonsaiapi:domain-events:rabbitmq:consume';
    private $consumer;
    private $connections;
    private $locator;
