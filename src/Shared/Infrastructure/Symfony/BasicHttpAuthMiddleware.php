...
use MyBonsaiApi\Backoffice\Auth\Application\Authenticate\AuthenticateUserCommand;
use MyBonsaiApi\Backoffice\Auth\Domain\InvalidAuthCredentials;
use MyBonsaiApi\Backoffice\Auth\Domain\InvalidAuthUsername;
...
final class BasicHttpAuthMiddleware
{
    ...
    {
        $event->setResponse(
            new Response('', Response::HTTP_UNAUTHORIZED, ['WWW-Authenticate' => 'Basic realm="MyBonsaiApi"'])
        );
    }
}
