...
namespace MyBonsaiApi\Shared\Infrastructure\Doctrine;

use MyBonsaiApi\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
    private static $sharedPrefixes = [
        __DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'MyBonsaiApi\Shared\Domain',
    ];
